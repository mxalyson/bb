"""
VALIDAÇÃO SEM COOLDOWN (0 CANDLES)
Versão do 2.py SEM cooldown para testar máximo potencial do modelo
Diferença: cooldown = 0 (SEM ESPERA) - permite trades consecutivos
"""
        ...
        for i in range(len(df)):
            ...
            if position:
                ...
                if exit_reason:
                    ...
                    position = None
                    cooldown = 0  # SEM COOLDOWN: Permite trade imediato após fechar posição
